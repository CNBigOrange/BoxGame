...
// Called every frame
void ABoxManeger::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);

}

void ABoxManeger::SetBoxTexture(TArray<AActor*> Actors, TMap<int32, F_NumPair> Map)
{
	/************************获取场景中方块*************************/
